...
export const Export = () => {
  ...
  return (
    <div className="relative h-full select-none">
      <div
        className="flex flex-row gap-2 items-center justify-center p-2 rounded-xl cursor-pointer border-[1px] border-zinc-700 hover:border-zinc-400 dark:border-zinc-600 dark:hover:border-black"
